...
const JobCard = ({ id, name, status, botName }) => {
      ...
      <div className="shadow-lg p-6 rounded-lg">
        ...
        <div className="mb-2">
          {status === "completed" ? (
            ...
            <span className="text-sm bg-yellow-500">{status} </span>
          )}
        </div>
        <div className="flex gap-2 items-center my-4">
          <BsRobot />
          <p className="leading-relaxed text-sm">Bot: {botName}</p>
        </div>
        {/* <div className="flex gap-1 items-center my-4">
        <BsClock />
        <p className="leading-relaxed text-sm">Created: 6 minutes ago.</p>
      </div> */}
